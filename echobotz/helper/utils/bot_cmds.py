...
CMD_HELP = {
    ...
    "vega": "Bypass VegaMovies links",
    "nexdrive": "Bypass NexDrive links",
    "pixelcdn": "Bypass PixelCDN links",
    "vcloud": "Bypass VCloud links",
    "hblinks": "Bypass HBLinks",
    "gdrex": "Bypass GDRex links",
    "extraflix": "Bypass ExtraFlix links",
    "neo": "Bypass NeoDrive/Neolinks",
    "gofile": "Bypass Gofile Folder/File",
    ...
    # New OTT platforms
    "hotstar": "Scrape Disney+ Hotstar poster from URL",
    "sonyliv": "Scrape SonyLIV poster from URL",
    "voot": "Scrape Voot poster from URL",
    "jiocinema": "Scrape JioCinema poster from URL",
    "ping": "Pong",
